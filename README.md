...
- [SolutionAnalysis](SolutionAnalysis/ "Link to solution analysis")
 	- Improvements&FurtherDevelopments : [implementation analysis](SolutionAnalysis/Improvements_FurtherDevelopments.pdf "implementation analysed")
