...
class DemoApplication(SDNApplication):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.info("Demo IOT Application")
    ...
    def packet_in_handler(self, ev):
        ...
        our_address_range = IPNetwork("21.0.0.0/8")
